<template>
  ...
  <div class="center-horizontal full-size">
    <div>
      ...
      <div class="center-horizontal">
        <div class="center-horizontal">
          <UIButton :title="lang.jwc.joinButton" @click="onClickJoin" color="third-color-background"/>
        </div>
      </div>
      <div class="center-horizontal">
